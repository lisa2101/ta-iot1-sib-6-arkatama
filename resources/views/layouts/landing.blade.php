...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="images/logo_eg.png">
</head>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/logo_eg.svg" alt="alternative"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="Https://wa.me/6285785474930">Contact</a>
                </li>

                {{-- cek apakah susdah login --}}
                @if (Auth::check())
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">EnviroGuard</span> Welcome</h1>
                            <p class="p-large">EnviroGuard is an IoT-based real-time environmental monitoring platform
                                that enables users to monitor various environmental parameters and track trends in
