...
@section('content')
    <div class="iq-card">
        <div class="iq-card-header d-flex justify-content-between align-item-center">
                ...
                <div class="modal-body">
                    <form id = "addForm">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="password" class="form-control is-invalid" id="addPassword"name="password">
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form id = "editForm">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="password" class="form-control is-invalid"
                ...
                .fail((error) => {
                    ...
                    if (response.errors) {
                        ...
                        for (const error in response.errors) {
                            console.log(error);
                            // cari input nama yang error pada #addForm
            ...
            $.post(url, data)
                ...
                .fail((error) => {
                    ...
                    if (response.errors) {
                        ...
                        for (const error in response.errors) {
                            console.log(error);
                            // cari input nama yang error pada #editForm
